from typing import TYPE_CHECKING, Type, Optional, List, TypeVar
...
if TYPE_CHECKING:
    ...
    ModelType = TypeVar('ModelType', bound=Model)  # removes IDE warning on subclasses
...
class ORM:
    ...
    async def update(self, **kwargs) -> List['ModelType']:
        orm = self._get_orm()
